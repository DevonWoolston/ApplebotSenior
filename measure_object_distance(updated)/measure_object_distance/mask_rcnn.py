...
class MaskRCNN:
    ...
    def draw_object_info(self, bgr_frame, depth_frame):
        ...
        for box, class_id, obj_center in zip(self.obj_boxes, self.obj_classes, self.obj_centers):
            ...
            cv2.rectangle(bgr_frame, (x, y), (x + 200, y + 70), color, -1)
            cv2.putText(bgr_frame, class_name.capitalize(), (x + 5, y + 20), 0, 0.5, (255, 255, 255), 2)
            cv2.putText(bgr_frame, "{} cm".format(depth_mm / 10), (x + 5, y + 40), 0, 0.5, (255, 255, 255), 2)
            cv2.putText(bgr_frame, "Center ({}, {})".format(cx, cy), (x + 5 , y + 60), 0, 0.5, (255, 255, 255), 2)
